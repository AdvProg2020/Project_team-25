...
//        setupBGM();
    ...
    public static void setupBGM() {
        backgroundMusic = new Media(ClientMain.class.getResource("/Audio/Tarantulas_by_Christian_Nanzell_Trimmed.wav").toExternalForm());
    ...
    public static void setApplicationStage(Stage applicationStage) {
        ClientMain.applicationStage = applicationStage;
    }
/*
