...
//            MainServer server = new MainServer();
    ...
    public static void setTest() {
        ...
        Seller seller1 = new Seller("jackRipper", "jack", "ripper", "lab@lab.com", "0950", "1234", "company1", "describe");
        Seller seller2 = new Seller("seller2", "seller2", "seller2", "lab@lab.com", "0930", "1234", "company2", "describe");
        ...
        Customer customer = new Customer("customer1", "customer1", "customer1", "lab@lab.com", "0912", "1234");
        customer.setMoney(1000);
        Customer customer2 = new Customer("customer2", "customer2", "customer1", "p@p.com", "0912", "1234");
        customer.setMoney(1000);

        Customer.addCustomer(customer, 12500);
        Customer.addCustomer(customer2, 1350);
